...
//        保存记录
    ...
    private void createList(List<SearchRecommend.DataBean> list) {
        for (String s : arr) {
            SearchRecommend.DataBean dataBean = new SearchRecommend.DataBean();
            dataBean.setKeyword(s);
            list.add(dataBean);
        }
    }
