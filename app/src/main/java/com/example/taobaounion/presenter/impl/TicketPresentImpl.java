...
public class TicketPresentImpl implements ITicketPresenter {
    ...
    private FlashSaleData mFlashSaleData;
    ...
    @Override
    public void getTicket(String url, String title, String cover, long couponAmount) {
        LogUtils.d(this, "url == " + url);
//        LogUtils.d(this,"cover == "+ cover);
//        LogUtils.d(this,"title == "+ title);
        mCover = UrlUtil.getCoverUrl(cover);
        mFlashSaleData = new FlashSaleData();
        mFlashSaleData.setLinkUrl(url);
        mFlashSaleData.setTitles(title);
        mFlashSaleData.setCover(mCover);
        mFlashSaleData.setCouponCount(couponAmount);
    ...
    private void onLoadSuccess() {
        if (mITicketCallBack != null) {
            mITicketCallBack.onTicket(mTicket, mFlashSaleData);
        } else {
