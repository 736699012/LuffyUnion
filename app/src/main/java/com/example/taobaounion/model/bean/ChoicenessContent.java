...
public class ChoicenessContent {
    ...
    public static class DataBean {
        ...
        public String toString() {
            return "DataBean{" +
                    "tbk_uatm_favorites_item_get_response=" + tbk_dg_optimus_material_response +
                    '}';
        }
            ...
            public static class ResultsBean {
                ...
                public static class UatmTbkItemBean implements IBaseInfo{
                    ...
                    public String getLink() {
                        return getCoupon_click_url()==null ?getClick_url():getCoupon_click_url();
                    }
